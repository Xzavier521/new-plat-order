...
//        response.setHeader("Access-Control-Allow-Origin","*");
//        WeCharOrdeDetail detail = new WeCharOrdeDetail();
//        detail.setOid("c415_201807161016520004");
//        detail.setProductname("皮皮畅");
//        return weCharOrdeDetailService.updateByPrimaryOid(detail);
//    }
//
//}
